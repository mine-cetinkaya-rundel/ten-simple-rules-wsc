...
institute: Duke University, Department of Statistical Science <br> 🔗 [duke.is/10-simple-rules-wsc](https://duke.is/10-simple-rules-wsc)
date: 2026-03-10 
date-format: long
format: 
  revealjs:
...
title-slide-attributes:
  data-background-image: images/qrcode.png
  data-background-size: 100px
  data-background-position: bottom 15px left 50px
---
...
🔗 [duke.is/10-simple-rules-wsc](https://duke.is/10-simple-rules-wsc)

![](images/qrcode.png){fig-alt="QR code for duke.is/10-simple-rules-wsc" width=200px style="border-style: solid; border-color: #9BB7D4; border-width: 1px;"}
